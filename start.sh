...
docker run --name sonarr -d -p 8989:8989 -u root -v /etc/localtime:/etc/localtime:ro -v $STORAGEDIR:/volumes/media:rw -v $DLDIR:/volumes/completed:rw -v $DATADIR/sonarr:/volumes/config:rw tuxeh/sonarr
...
docker run --name sabnzbd -d -p 8080:8080 -v /etc/localtime:/etc/localtime:ro -v $DLDIR:/mnt/downloads:rw -v $DATADIR/sabnzbd:/mnt/state:rw -v $STORAGEDIR:/mnt/nas:rw -v $TMPDIR:/mnt/tmp:rw sabnzbd-image
